...
function ImpactBar({ row, delay }: { row: ImpactRow; delay: number }) {
  ...
  const tone = row.tone === "amber" ? "bg-amber-500" : "bg-leaf-500";
  const textTone = row.tone === "amber" ? "text-amber-600" : "text-moss";
  return (
    <div
      ref={ref}
      className={`reveal grid items-center gap-4 border-t border-ink/12 py-7 last:border-b lg:grid-cols-12 lg:gap-8 ${
        inView ? "in" : ""
      }`}
    ...
    >
      ...
      <p className="text-sm leading-relaxed text-sage lg:col-span-4 lg:text-base">
        {row.label}
      </p>
      <div className="lg:col-span-4">
        ...
        <p className="mt-2 text-right font-mono text-[9px] uppercase tracking-[0.2em] text-sage/80">
      ...
      <div className="relative px-5 py-24 sm:px-8 lg:px-14 lg:py-32 xl:px-20">
        <div className="grid gap-8 lg:grid-cols-12 lg:items-end">
          <div className="lg:col-span-7">
            <Eyebrow index="05">Impact ledger</Eyebrow>
            <Lines
              ...
              lines={[
                ...
                <span key="b">
                  than it takes<span className="text-amber-500">.</span>
                </span>,
              ]}
            />
          </div>
          <p className="max-w-sm text-base leading-relaxed text-sage lg:col-span-4 lg:col-start-9">
        ...
        <Reveal delay={120} className="mt-16">
          <blockquote className="border-l-4 border-amber-500 pl-6 sm:pl-8">
            ...
            <footer className="mt-4 font-mono text-[11px] uppercase tracking-[0.24em] text-sage">
