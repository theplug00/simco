...
export default function Projects() {
  return (
    <section id="projects" className="relative scroll-mt-20 overflow-hidden bg-charcoal-950 text-snow">
      <div className="pointer-events-none absolute left-1/2 top-0 h-[420px] w-[720px] -translate-x-1/2 rounded-full bg-cyan-500/6 blur-[130px]" />
          ...
          <div className="lg:col-span-7">
            ...
            <Lines
              ...
              lines={[
                ...
                <span key="b">
                  concrete <span className="text-cyan-400">&amp;</span> copper
        ...
        <div className="relative mt-16 flex flex-col gap-8 lg:mt-20">
          {PROJECTS.map((p, i) => (
            <article
              ...
              className="sticky grid overflow-hidden rounded-lg border border-white/10 bg-charcoal-850 shadow-[0_-18px_60px_rgba(0,0,0,0.6)] md:grid-cols-2"
            >
              <div className="group relative h-64 overflow-hidden sm:h-80 md:h-auto md:min-h-[420px]">
                ...
                />
                <div className="pointer-events-none absolute inset-0 bg-gradient-to-r from-transparent to-charcoal-850/50" />
                <span className="glass-dark absolute left-4 top-4 rounded-md px-3 py-1.5 font-mono text-[10px] uppercase tracking-[0.2em] text-cyan-300">
                  {p.index}
                </span>
              </div>

              <div className="flex flex-col justify-center p-7 sm:p-9 lg:p-12">
                <p className="font-mono text-[10px] uppercase tracking-[0.26em] text-green-400">
                  {p.sector}
                </p>
                ...
                <dl className="mt-7 grid grid-cols-2 gap-x-6 gap-y-5 border-t border-white/10 pt-7">
                  {p.specs.map((s) => (
                    <div key={s.label}>
                      <dt className="font-mono text-[9px] uppercase tracking-[0.22em] text-mist">
                        {s.label}
                      </dt>
                      <dd className="font-display mt-1 text-lg font-bold text-snow sm:text-xl">
                        {s.value}
                      </dd>
                    </div>
                  ))}
                ...
                <p className="mt-7 flex items-start gap-3 border-l-2 border-cyan-500 pl-4 text-sm leading-relaxed text-mist">
        ...
        <Reveal delay={120} className="mt-16 flex justify-center">
          <p className="font-mono text-[11px] uppercase tracking-[0.24em] text-mist">
            ...
            <a
              ...
              className="link-sweep text-cyan-400"
            >
              ask for it
            </a>
          </p>
