...
export function LogoMark({ className = "h-9 w-9" }: { className?: string }) {
  return (
    <svg viewBox="0 0 40 40" className={className} aria-hidden="true">
      <rect x="1" y="1" width="38" height="38" rx="9" fill="#E29A2B" />
      <circle cx="20" cy="20" r="7" fill="#08110C" />
      <g stroke="#08110C" strokeWidth="2.4" strokeLinecap="round">
...
export function SunArc({ className = "" }: { className?: string }) {
  return (
    ...
    >
      ...
      <circle cx="300" cy="300" r="52" fill="rgba(226,154,43,0.9)" />
      <g stroke="#B9E471" strokeWidth="2" strokeLinecap="round" opacity="0.8">
